...
export default function FAQPageUI({ dict }: FAQPageUIProps) {
    ...
    <>
      ...
      <main className="flex flex-col lg:flex-row items-center justify-center w-full bg-white py-20 px-6 lg:px-32">
        ...
        <div className="w-full lg:w-1/2">
          <p className="text-sm font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#301f50] to-[#f7d416] mb-2">
            FAQ
          </p>
