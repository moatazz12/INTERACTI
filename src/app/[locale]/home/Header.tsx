...
export default function Header() {
  ...
  return (
<header className="w-full px-6 py-4 bg-transparent relative z-50 overflow-visible">
      <div className="max-w-8xl mx-auto flex items-center justify-between h-16 relative">
        ...
        {/* Desktop Navbar */}
        <nav className="hidden custom-xl:flex flex-grow justify-center space-x-16 text-sm font-semibold text-gray-800 h-full items-center">
          {navItems.map((item) => (
            <div key={item.label} className="relative flex flex-col items-center">
              ...
              {item.label === 'Services' ? (
                <div className="relative" ref={dropdownRef}>
                  ...
                  {desktopDropdownOpen && (
                    <div className="absolute top-full left-0 mt-20 z-80">
                    <DesktopServicesDropdown isOpen={true} locale={locale} />
                    </div>
                  )}
                </div>
              ) : (
        ...
        <div className="flex items-center space-x-4">
          ...
          {/* Mobile Menu Toggle */}
          <button
            className="custom-xl:hidden text-[#330052]"
                  ...
                  <>
                    ...
                    {mobileDropdownOpen && (
                      <div className="w-full bg-gray-50 px-4 pb-4">
                        <MobileServicesDropdown isOpen={mobileDropdownOpen} locale={locale} />
