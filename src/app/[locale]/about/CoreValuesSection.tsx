...
// Lazy load icons with code splitting
...
const ICONS = [LuAward, LuShieldCheck, LuZap, LuUsers, LuHeartHandshake, LuTrendingUp];
...
const CoreValuesSection = memo(({ dict }: { dict: Corevalue }) => {
  ...
  return (
    <section
      ref={sectionRef}
      className={`w-full bg-white py-12 md:py-8 px-2 my-4 ${styles.coreValuesSection}`}
    ...
    >
      <div className="max-w-[1100px] mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8 md:gap-12 mt-8 justify-center items-center">
          {isVisible &&
